    ...
    children: [
      {
        ...
        name: 'Documentation',
        meta: { title: '文件', icon: 'education', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'CreateCity',
        meta: { title: 'Create City', icon: 'edit' }
      },
      {
        path: 'edit/:id',
        component: () => import('@/views/city/edit'),
        name: 'EditCity',
        meta: { title: 'Edit City', noCache: true, icon: 'edit', activeMenu: '/city/list' },
        hidden: true
      },
      {
        path: 'list',
        ...
        name: 'CityList',
        meta: { title: 'City List', icon: 'list' }
      }
    ]
  },
  {
